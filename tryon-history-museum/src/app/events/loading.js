...
import { EventCardSkeleton, SkeletonPulse } from "@/components/Skeleton";
    ...
    <main id="main-content">
      ...
      >
        <div className="max-w-[1200px] mx-auto px-5 md:px-8 relative z-10">
          ...
          <SkeletonPulse className="h-12 w-72 mb-6" style={{ background: "rgba(255,255,255,0.08)" }} />
      ...
      <section className="bg-tryon-cream py-16 md:py-20">
        <div className="max-w-[900px] mx-auto px-5 md:px-8">
          <SkeletonPulse className="h-3 w-32 mb-10" />
