/**
 * History Bits — static content data file
 * 
 * To add a new article:
 * 1. Copy an existing entry below
 * 2. Update all fields
 * 3. Add the new slug to the index page filter if needed
 * 
 * Categories: "notable-people" | "cultural-history" | "historic-places"
 */

export const historyBits = [
  {
    slug: "carter-brown",
    title: "Carter Brown",
    category: "notable-people",
    categoryLabel: "Notable People",
    excerpt: "When Carter Brown arrived in Tryon in 1917, he set in motion a transformation that would make this small mountain town one of America's premier equestrian destinations.",
...
The Pine Crest Inn was constructed in 1906, and has welcomed guests since equestrian Carter Brown converted it to an inn in 1917. It was added to the National Register of Historic Places in 1982.`,
  },
  {
    ...
    category: "notable-people",
    categoryLabel: "Notable People",
    excerpt: "Between critical acclaim and an 18-year silence, Lilian Jackson Braun wrote 29 mystery novels — the last at age 93 — and spent her final years in Tryon.",
    image: "https://images.squarespace-cdn.com/content/v1/63d97c255bc4c8084c6e5e50/943c5f55-2b5c-4cf4-8a67-c41fce52773a/lilian_jackson_braun_cat.jpg",
    images: [
      "https://images.squarespace-cdn.com/content/v1/63d97c255bc4c8084c6e5e50/4ff3d0f8-b862-4057-b1fc-546749066948/laterbloomer.jpg",
      "https://images.squarespace-cdn.com/content/v1/63d97c255bc4c8084c6e5e50/a8afc5e7-4381-4aca-beb7-87ee5fe234a4/LJB.jpg",
      "https://images.squarespace-cdn.com/content/v1/63d97c255bc4c8084c6e5e50/7c734dae-7cb7-40ee-b9a0-b6bc4bcbc76f/lilian_jackson_braun_cat2.jpg",
      "https://images.squarespace-cdn.com/content/v1/63d97c255bc4c8084c6e5e50/b00bd35b-a0b9-4537-9f44-5cef6855d257/catwhosniffedglue.jpg",
    ],
    body: `The history of Lilian Jackson Braun is perhaps as exciting and mysterious as her novels. Between 1966 and 1968, she published three novels to critical acclaim: The Cat Who Could Read Backwards, The Cat Who Ate Danish Modern, and The Cat Who Turned On and Off. In 1966, The New York Times labeled Braun "the new detective of the year." Then, discouraged by the market's seemingly insatiable demand for sex and violence in mystery novels, she set the series aside for 18 years.

After retiring from The Detroit Free Press, where she was the "Good Living" editor for 29 years, she took up the series again with the publication of The Cat Who Saw Red (1986). Within two years her publisher, Berkley, released four new novels in paperback and reprinted the three mysteries from the sixties. The 29th novel in the series, The Cat Who Had 60 Whiskers, was published in 2007 when she was 93 years old.
...
/**
 * Helper: get all articles in a category
 */
export function getByCategory(category) {
  return historyBits.filter((a) => a.category === category);
}
...
export function getBySlug(slug) {
  return historyBits.find((a) => a.slug === slug) || null;
}
...
export const CATEGORIES = [
  { value: "all", label: "All" },
  { value: "notable-people", label: "Notable People" },
  { value: "cultural-history", label: "Cultural History" },
  { value: "historic-places", label: "Historic Places" },
];
